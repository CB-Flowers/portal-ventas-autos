...
@Component({
  selector: 'app-pag-register',
  templateUrl: './pag-register.component.html',
  styleUrls: ['./pag-register.component.css']
})
export class PagRegisterComponent implements OnInit {
